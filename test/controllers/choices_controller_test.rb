...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { name: @choice.name, price: @choice.price, selected: @choice.selected, url: @choice.url } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { name: @choice.name, price: @choice.price, selected: @choice.selected, url: @choice.url } }
